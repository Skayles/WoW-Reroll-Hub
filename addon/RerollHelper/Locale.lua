...
translations.en = {
	...
	tabTotal = "Total",
	ilvlShort = "ilvl %d",
	tipHeader = "Droptimizer",
	tipLevel = "Ilvl du rapport",
	tipBase = "L'infobulle ci-dessus montre l'objet a son niveau de base.",
	tipHeader = "Droptimizer",
	tipLevel = "Report item level",
	tipBase = "The tooltip above shows the item at its base level.",
