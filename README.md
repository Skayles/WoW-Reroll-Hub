...
| File | Use |
| --- | --- |
| `WoW-Reroll-Hub-Setup-0.2.3.exe` | **Installer.** Installs for the current user (no admin rights needed), creates a desktop shortcut and a Start menu entry, and registers in "Apps & features" for uninstalling. |
| `WoW-Reroll-Hub-portable-0.2.3.exe` | **Portable.** A single file, no installation: drop it anywhere (USB stick included) and double-click. |
